...
function MockConversationPanel() {
  return (
    <div className="w-full mx-auto my-6 lg:my-10 bg-[#1D1830] border border-[#2C2640] rounded-2xl p-3 lg:p-4 flex flex-col">
      ...
      <div className="flex flex-col gap-2 pr-1">
        {mockConversationData.map((conversationData) => {
          ...
          return (
            <div key={conversationData.id} className={`flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
              <TypeWriterEffect
